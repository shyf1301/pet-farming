...
var petArray =  [
                  {name:"Mambo",      fragments:0,  req:[2,3,13,104]},
                  {name:"Joe",        fragments:0,	req:[4,5,17,106]},
                  {name:"Mummy",      fragments:0,	req:[6,7,21,108]},
                  {name:"Piggy",      fragments:0,	req:[8,9,25,110]},
                  {name:"Potang",     fragments:0,	req:[10,11,29,112]},
                  {name:"Uni",        fragments:0,	req:[12,15,33,114]},
                  {name:"Joker",      fragments:0,	req:[14,19,37,116]},
                  {name:"Snork",      fragments:0,	req:[16,23,41,118]},
                  {name:"Phoenic",    fragments:0,	req:[18,27,45,120]},
                  {name:"Indy",       fragments:0,	req:[20,31,49,122]},
                  {name:"Grim",       fragments:0,	req:[22,35,53,124]},
                  {name:"Woola",      fragments:0,	req:[24,39,57,126]},
                  {name:"Lamp",       fragments:0,	req:[26,43,61,128]},
                  {name:"Tinkey",     fragments:0,	req:[28,47,65,130]},
                  {name:"Sleepy",     fragments:0,	req:[30,51,69,132]},
                  {name:"Totem",      fragments:0,	req:[32,55,73,134]},
                  {name:"Icy",        fragments:0,	req:[34,59,77,136]},
                  {name:"Squirrel",   fragments:0,	req:[36,63,81,138]},
                  {name:"Moon",       fragments:0,	req:[38,67,85,140]},
